...
const handleShare = async () => {
    if (navigator.share) {
      try {
        ...
        console.log('✅ با موفقیت به اشتراک گذاشته شد!');
      } catch (err) {
  ...
  const relatedRecipes = [
    { title: 'Teriyaki Chicken', time: '35 min', calories: '520 cal', img: 'http://static.photos/food/640x360/143' },
    { title: 'Rice Noodle Bowl', time: '20 min', calories: '380 cal', img: 'http://static.photos/food/640x360/145' },
    { title: 'Broccoli Stir Fry', time: '25 min', calories: '420 cal', img: 'http://static.photos/food/640x360/172' }
  ];
    ...
    <>
      ...
      <div className="page-container">
        ...
        <main>
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${recipe?.image})`,
            ...
            <div className="hero-container">
              <div className="hero-content">
                <div className="hero-header">
                  <div>
                    <span className="time-badge">{recipe.cook_time} minutes</span>
              ...
              <div className="content-layout">
                <div className="main-content">
                  ...
                  <div className="card notes-card">
                    ...
                    <p className="note-text">{recipe.notes}</p>
                  </div>
                </div>
        ...
        <footer className="footer">
          <div className="footer-container">
            <div className="footer-grid">
              <div>
                <h3 className="footer-brand">CookMate</h3>
            ...
            <div className="footer-bottom">
              <p>© 2023 CookMate. All rights reserved.</p>
            </div>
          </div>
        </footer>
<SpeedInsights/>
